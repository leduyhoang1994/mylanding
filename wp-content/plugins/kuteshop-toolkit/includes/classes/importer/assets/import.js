;(function ($) {
    ...
    $(document).on('click', '.kt-button-import', function () {
        ...
        var import_full_content = false,
            ...
            import_footer       = false,
            import_megamenu     = false,
            import_testimonial  = false,
            import_menu         = false,
            import_widget       = false,
        ...
        if ( import_footer ) {
            var data = {
                'action': 'kt_import_footer_content',
                'optionid': optionid,
            }
            kt_arr_import_request_data.push(data);
        }
        if ( import_megamenu ) {
            var data = {
                'action': 'kt_import_megamenu',
                'optionid': optionid,
            }
            kt_arr_import_request_data.push(data);
        }
        if ( import_testimonial ) {
            var data = {
                'action': 'kt_import_testimonial',
                'optionid': optionid,
            }
            kt_arr_import_request_data.push(data);
        }
    ...
    $(document).on('change', '.kt_import_full_content', function () {
        var _this = $(this);
        if ( _this.is(':checked') ) {
